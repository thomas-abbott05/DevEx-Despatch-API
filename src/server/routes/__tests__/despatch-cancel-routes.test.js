...
jest.mock('../../despatch/despatch-cancel-order', () => ({
  cancelDespatchAdvice: jest.fn(),
  getCancellation: jest.fn()
}));

jest.mock('../../despatch/despatch-cancel-fulfilment', () => ({
  createFulfilmentCancellation: jest.fn(),
  getFulfilmentCancellation: jest.fn()
}));

jest.mock('../../despatch/despatch-cancel-order-request-helper', () => ({
...
jest.mock('../../despatch/despatch-cancel-fulfilment-helper', () => ({
